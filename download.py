...
and then of https://github.com/carpedm20/DCGAN-tensorflow/blob/master/download.py
...
parser.add_argument('path', type=str, help='path of directory to download dataset in')
...
if __name__ == '__main__':
  ...
  if 'celebA' in args.datasets:
    download_celeb_a(args.path)
  if 'lsun' in args.datasets:
    download_lsun(args.path)
  if 'mnist' in args.datasets:
    download_mnist(args.path)
